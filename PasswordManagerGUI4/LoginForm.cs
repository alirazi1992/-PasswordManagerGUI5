    ...
    public partial class LoginForm : Form
    {
        ...
        private void LoginForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                pnlSet.Visible = !hasMaster;  // first run → set password
                pnlLogin.Visible = hasMaster;  // next runs → enter password
                lblMessage.Text = "";
...
CREATE TABLE IF NOT EXISTS Accounts (
    ...
    Password TEXT NOT NULL
        ...
        // Next runs — verify master password
        ...
        // PBKDF2: store salt(16) + key(32) as base64
        ...
        private bool VerifyPassword(string password, string stored)
        {
            try
            {
                ...
                using (var kdf = new Rfc2898DeriveBytes(password, salt, 10000, HashAlgorithmName.SHA256))
                {
                    ...
                    return SlowEquals(key, test); // constant-time compare
                }
            }
            catch { return false; }
        }
